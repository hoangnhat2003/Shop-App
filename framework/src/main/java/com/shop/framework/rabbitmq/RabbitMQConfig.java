...
public class RabbitMQConfig{
    ...
    @Bean
    public Queue queue() {
        return new Queue(RabbitMQInit.QUEUE, false);
    }
    @Bean
    public DirectExchange exchange() {
        return new DirectExchange(RabbitMQInit.EXCHANGE);
    }
    @Bean
    public Binding binding(Queue queue, DirectExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with(RabbitMQInit.ROUTING_KEY);
    }
    ...
    public AmqpTemplate rabbitTemplate(ConnectionFactory connectionFactory) {
        ...
        rabbitTemplate.setDefaultReceiveQueue(RabbitMQInit.QUEUE);
